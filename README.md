...
***
## 📑 Hey, I'm Emi
A developer and entrepreneur from Helsinki, Finland. I do this and that related to business, code and 3D stuff; be it websites, games, animations or art. I love to pick up skills and learn new things. Right now I'm learning more about deep learning and ai on <a href="https://zerotomastery.io/courses/" target=”blank”>ZeroToMastery</a>. Do contact me if you're interested in working together.

If "Creativity is allowing yourself to make mistakes. Art is knowing which ones to keep.”(Scott Adams), with this logic one can say that "Codes are purely mistakes, where some work and some don't. While coding in itself is an art, and developers are artists who make it work by knowing what to keep."
...
!! OLD INTRO !!
A 19 yo developer and entrepreneur from Helsinki, Finland. I've made things from websites, desktop applications, small video games and mobile apps to 3D designs, -animations and music. I also have experience with SEO (search engine optimization), cyber security as well as team & project management. Though I might be a full rounded dev, I still love to pick up new skills and learn new things as I go C:
--->
